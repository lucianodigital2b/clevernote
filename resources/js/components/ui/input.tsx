...
function Input({ className, type, disableDarkMode = false, ...props }: React.ComponentProps<"input"> & { disableDarkMode?: boolean }) {
  return (
    <input
      type={type}
      data-slot="input"
      className={cn(
        ...
        !disableDarkMode && "dark:aria-invalid:ring-destructive/40",
        className
      )}
      {...props}
    />
