...
const pricingPlans = [
  ...
  },
  {
    ...
    features: [
      ...
      { included: true, text: "5GB file storage" },
      { included: true, text: "Basic AI summaries (10/mo)" },
